          ...
          <div>
            <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
              <div className="relative flex h-16 items-center justify-between">
                ...
                <div className="flex flex-shrink-0 items-center text-neutral-100 text-2xl">
                  Abdul-Majid Aladejana
                </div>
                <div className=" absolute right-5 flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
